<!--==================================================-->
<!-- Start toptech Footer Area -->
<!--==================================================-->
<div class="footer-area" data-cues="zoomIn">
	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-md-6">
				<div class="single-footer-box">
					<div class="footer-logo">
						<a href="index.php"><img src="{{ asset('home/assets/images/header-logo.png') }}" alt="logo"></a>
					</div>
				...
				<div class="footer-section">
					...
					<div class="subscribe-widget">
						<div class="widget-desc">
							<p>The latest news article and resources
								in your inbox every month.</p>
						</div>
